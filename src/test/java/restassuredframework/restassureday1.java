...
public class restassureday1 {
	...
	{
		RestAssured.baseURI="http://localhost:3000/";		
		String bodyvariable  = "{\"name\":\"Neerajkumar\",\"batchno\":\"Mahadevas\"}";
		given()
	...
	public void testcase6()
	{
		...
		given()
	      .queryParam("username","Neeraj Kumar")
	   ...
	   
	{
	    ...
	    studentdata[0][0]= "Vamsi";
	    studentdata[0][1]= "5";
	    studentdata[1][0]= "Kumar";
	    studentdata[1][1]= "7";
		return studentdata;
